...
use actix_web::{
    ...
    web,
    web::Json,
    App, BaseHttpResponse, Error, HttpMessage, HttpRequest, HttpResponse, HttpServer, Responder,
};
use futures::{
    future::{self, Either},
    Future,
...
pub fn early_response<R: Into<BaseHttpResponse<Body>>>(
    req: ServiceRequest,
    response: R,
) -> ActixFuture {
...
pub fn early_response_left<R: Into<BaseHttpResponse<Body>>>(
    req: ServiceRequest,
    response: R,
) -> ActixFutureLeft {
